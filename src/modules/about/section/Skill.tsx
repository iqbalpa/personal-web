...
const Skill: React.FC = () => {
  return (
    ...
    >
      ...
      <p>
        <span className="font-bold">Languages:</span> Python, Java, Javascript,
        Typescript, Go, C++, SQL
      </p>
      <p>
        <span className="font-bold">Backend Tools:</span> Django, Express,
        Springboot, Go Gin, Node JS, FastAPI
      </p>
      <p>
      ...
      <p>
        ...
        MySQL, MongoDB, Docker, GCP, Sonarcloud
      </p>
      <p>
      ...
      <p>
        <span className="font-bold">Skills:</span> Website Development, Machine
        Learning, Software Engineering, Data Science
      </p>
      <p>
